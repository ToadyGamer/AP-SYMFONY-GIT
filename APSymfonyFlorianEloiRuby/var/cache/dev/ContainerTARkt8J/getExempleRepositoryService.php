 ...
 */
class getExempleRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ExempleRepository' shared autowired service.
     *
     * @return \App\Repository\ExempleRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ExempleRepository.php';

        return $container->privates['App\\Repository\\ExempleRepository'] = new \App\Repository\ExempleRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
